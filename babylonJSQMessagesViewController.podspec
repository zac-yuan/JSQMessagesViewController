Pod::Spec.new do |s|
	s.name = 'babylonJSQMessagesViewController'
	s.version = '7.3.4-Babylon-1'
	...
	s.source = { :git => 'https://github.com/Babylonpartners/JSQMessagesViewController.git', :tag => s.version }
